...
export default function ProductCard(props){
    const { productName, slug, imageSrc="/images/product-3.jpg", hideAddToCart }=props;
    ...
    return (
        <div className="product">
            <div className="img-prod pointer"  onClick={handleProductClick}>
                <Image height="700px" width="500px" className="img-fluid" src={imageSrc} alt="Colorlib Template" />
                <span className="status">30%</span>
            </div>
            <div className="text">
                    <div className='pt-3 px-3 pointer' onClick={handleProductClick}>
                        <h3 className='text-capitalize'>{productName}</h3>
                ...
                {!hideAddToCart && isCartAvailable && <div className='pb-3 px-3'><hr />
